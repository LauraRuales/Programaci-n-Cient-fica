...
%Retorna: La matriz con la eliminacion completada
tam= 6; %Cantidad de columnas de la matriz
Inversa = []; %Vector que almacenara la solucion al sistema de ecuaciones
for i = 1:3 %For que recorre la cantidad de filas
...
%pivotes en uno
for i = 1:tam-1 %El for recorre de la primera a la ultima fila
    for j = 1:tam-1 %El for recorre de la primera a la penultima columna (La ultima es el resultado de la multiplicacion)
    ...
    Inversa = Mat(4:end,:);%Vector solucion 
end